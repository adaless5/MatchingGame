        ...
        case WM_MOUSEMOVE:
            {
                ...
                InputEvent* pEvent = new InputEvent( InputState::Moved, (int)-1, ivec2( x, y ) );
                pFramework->m_pEventManager->AddEventToQueue( pEvent );
            }
            return 0;
        ...
        case WM_LBUTTONDOWN:
            {
                ...
                InputEvent* pEvent = new InputEvent( InputState::Pressed, (int)0, ivec2( x, y ) );
                pFramework->m_pEventManager->AddEventToQueue( pEvent );
            }
            return 0;
        ...
        case WM_LBUTTONUP:
            {
                ...
                InputEvent* pEvent = new InputEvent( InputState::Released, (int)0, ivec2( x, y ) );
                pFramework->m_pEventManager->AddEventToQueue( pEvent );        
            }
            return 0;
